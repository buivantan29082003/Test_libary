 ...
 * @author Admin
 */
public class BarChartNXB extends javax.swing.JDialog {
    ...
    public BarChartNXB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
        showBarChart();
    ...
    public void showBarChart() {
        ...
        renderer.setMaximumBarWidth(0.04); // Điều chỉnh giá trị theo nhu cầu của bạn
        ...
        rangeAxis.setUpperBound(20); // Giá trị cao nhất
