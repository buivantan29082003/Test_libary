...
public class LayLaiMatKhau extends javax.swing.JFrame {
    ...
    String passwordRegex = "^(?=.*[A-Z])(?=.*[a-z])(?=.*\\d)(?=.*[@#$%^&+=])[A-Za-z\\d@#$%^&+=]{5,10}$";
...
//        dispose();
 ...
 private void init() {
    ...
    public static boolean checkMatKhau(JTextField txt) {
        NhanVienDao nv = new NhanVienDao();
        if (nv.selectByPassword(txt.getText()) != null) {
            return true;
        }
        return false;
    }
...
//        System.out.println(nv.getMatKhau());   
    ...
    public boolean checkPas() {
        String mk = new String(txtMKMoi.getPassword());
        Matcher pas = Pattern.compile(passwordRegex).matcher(mk);
        if (!pas.matches()) {
            JOptionPane.showMessageDialog(this, "Mật khẩu phải chứa 5-10 kí tự \nbao gồm chữ hoa số và kí tự đặc biệt.");
            return false;
        }
        return true;
    }
    ...
    public boolean kiemTra() {
        String mk = new String(txtMKMoi.getPassword());
        String nlmk = new String(txtNLMK.getPassword());
        System.out.println(mk);
        if (mk.equals("")) {
            MsgBox.alert(this, "Vui lòng nhập mật khẩu mới");
            return false;
        }
        if (checkMatKhau(txtMKMoi) == true) {
            MsgBox.alert(this, "Mật khẩu trùng với mật khẩu cũ của bạn");
            return false;
        }
        if (checkPas() == false) {
            return false;
        ...
        if (nlmk.equals("")) {
            MsgBox.alert(this, "Vui lòng nhập mật khẩu lại mật khẩu");
            return false;
        }

        if (!nlmk.equals(mk)) {
            MsgBox.alert(this, "Phải nhập giống mật khẩu mới");
            return false;
        }
