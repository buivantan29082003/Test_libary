 ...
 * @author Admin
 */
public class BarChartTheLoaiLine extends javax.swing.JDialog {
    ...
    public BarChartTheLoaiLine(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
...
//    plot.setBackgroundPaint(Color.YELLOW);
    ...
    return chart;
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            BarChartTheLoaiLine chart = new BarChartTheLoaiLine(frame, true);
            chart.pack();
