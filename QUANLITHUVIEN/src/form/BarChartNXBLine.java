 ...
 * @author Admin
 */
public class BarChartNXBLine extends javax.swing.JDialog {
    ...
    public BarChartNXBLine(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        List<Object[]> list = dao.getTheoNXB();
        for (Object[] row : list) {
...
//    plot.setBackgroundPaint(Color.YELLOW);
    ...
    return chart;
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            BarChartNXBLine chart = new BarChartNXBLine(frame, true);
            chart.pack();
